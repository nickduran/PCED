...
#### Note 
- **R3 vs R4 distinction**: The key difference is level of elaboration - does the provider meaningfully differentiate the options (benefits, risks, tradeoffs) or just list them? See [Coding Examples](/PCED/examples) if you would like additional clarification.  
